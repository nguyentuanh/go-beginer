...
func (e *TelExporter) ExportSpans(ctx context.Context, spans []sdktrace.ReadOnlySpan) error {
...
func (e *TelExporter) ConvertSpan(_ context.Context, sd sdktrace.ReadOnlySpan) *Span {
...
func New(ll l.Logger, id int64, token string, svr ITeleNotiService) *TelExporter {
	return &TelExporter{
		l:     ll,
		ID:    id,
		Token: token,
